...
checkpoint_filepath = "VGG16_weights.hdf5"
...
def save_bottlebeck_features():
	...
	np.save(open('VGG16_features_train.npy', 'wb'), features_train)
	...
	np.save(open('VGG16_features_validation.npy', 'wb'), features_validation)
