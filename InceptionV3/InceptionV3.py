...
checkpoint_filepath = "InceptionV3_weights.hdf5"
...
def save_bottlebeck_features():
	...
	np.save(open('InceptionV3_features_train.npy', 'wb'), bottleneck_features_train)
	...
	np.save(open('InceptionV3_features_validation.npy', 'wb'), bottleneck_features_validation)


def train_top_model():
	train_data = np.load(open('InceptionV3_features_train.npy', 'rb'))
	...
	validation_data = np.load(open('InceptionV3_features_validation.npy', 'rb'))
